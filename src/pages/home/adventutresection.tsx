...
const AdventureSection = () => {
  ...
  return (
    <section className="bg-[#0d1d18] text-white py-16 px-4">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-center items-start gap-10">
        {/* Left: List */}
        <div className="flex-1 flex justify-center">
          <div className="bg-white rounded-xl p-5 space-y-3 text-black w-full max-w-xs">
            {topics.map((topic) => (
              <div
                key={topic.id}
        ...
        <div className="flex-1 flex flex-col justify-center space-y-6 max-w-md">
          <div className="text-green-400 text-6xl">{activeTopic.icon}</div>
          ...
          {/* Stats */}
          <div>
            <div className="mb-2 text-sm text-gray-400">Satisfied Clients</div>
            <div className="w-full bg-gray-700 h-2 rounded">
              <div className="bg-green-500 h-2 w-[89%] rounded"></div>
            </div>
            <div className="mt-4 mb-2 text-sm text-gray-400">Success Rate</div>
            <div className="w-full bg-gray-700 h-2 rounded">
              <div className="bg-orange-500 h-2 w-[86%] rounded"></div>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 flex justify-center">
          <Image
            ...
            alt="Adventure" height={200} width={200}
