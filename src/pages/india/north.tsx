...
const northPlaces = [
  {
    ...
    description: 'Capital city with rich history and modern lifestyle.'
  },
  {
    name: 'Agra',
    image: '/india/east.jpg',
    description: 'Home of the iconic Taj Mahal and Mughal architecture.'
  },
  {
    name: 'Manali',
    image: '/india/east.jpg',
    description: 'A stunning hill station famous for snow and adventure.'
  },
  {
    name: 'Shimla',
    image: '/india/east.jpg',
    description: 'Queen of Hills with colonial charm and cool climate.'
  },
  {
    name: 'Jaipur',
    image: '/india/east.jpg',
...
const NorthIndia = () => {
  return (
    <div>
      <App_layout>
        <div className="max-w-7xl mx-auto bg-white py-16 px-6">
          <h1 className="text-3xl font-bold text-center mb-12">Top Places in North India</h1>

          {/* First row - 3 cards */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {northPlaces.slice(0, 3).map((place, index) => (
              <motion.div
                key={index}
          ...
          <div className="flex flex-col lg:flex-row justify-center gap-8">
            {northPlaces.slice(3).map((place, index) => (
              <motion.div
                key={index + 3}
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
